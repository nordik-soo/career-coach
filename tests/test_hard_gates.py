...
# ---------------------------------------------------------------------------
# Direct-title early-return path RETIRED in Step 2 (2026-07-16). The four
# tests that previously lived here locked hard-gates behavior on that
# early-return path. `_direct_title_match_score` is deleted; sub-min-skill
# jobs now return a deterministic ineligible MatchResult (score=0, low,
# match_eligible=False). Hard-gates coverage on the eligible-skills path
